...
export const ImageOutline = ({ className, onClick, ...rest }: Props) => {
  return (
    <svg
      ...
      {...rest}
    >
      <g clipPath={'url(#clip0_68650_2791)'}>
        <path
          d={
        ...
        <path
          d={
            'M5.8335 6.66675C6.38578 6.66675 6.8335 6.21903 6.8335 5.66675C6.8335 5.11446 6.38578 4.66675 5.8335 4.66675C5.28121 4.66675 4.8335 5.11446 4.8335 5.66675C4.8335 6.21903 5.28121 6.66675 5.8335 6.66675Z'
          }
          fill={'white'}
        />
      </g>
      <defs>
        <clipPath id={'clip0_68650_2791'}>
